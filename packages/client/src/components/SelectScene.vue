...
<template>
  <SelectRoot v-model="previewStore.curScene">
    <SelectTrigger
      class="h-[32px] min-w-35 inline-flex items-center justify-between gap-[5px] rounded px-[15px] text-[13px] leading-none shadow-[0_2px_10px] shadow-black/10 outline-none data-[placeholder]:text-blue6 focus:shadow-[0_0_0_2px] focus:shadow-black"
    ...
    <SelectPortal>
      <SelectContent
        class="will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade z-[100] min-w-35 rounded bg-white shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)] dark:bg-dark"
        :side-offset="5"
      >
        <SelectScrollUpButton
